# Cross-Customer Fleet Analysis — 2026-06-14 Morning Update
...
**Changes since June 13:** Zero fixes applied on either instance. Cumulative findings.md updated with Findings 10–12 (new June 14 content).
...
The earlier estimate of "9 days" was wrong. Heather has not checked Josh's email or iMessage in over 6 weeks. This predates the June 13 scan finding by a month and a half. The Google Workspace disconnection gap is far larger than previously documented.

### 3. Noah's AE Target Companies Report Is 52 Days Stale

The only output report in Noah's repo (`workspace/reports/ae-target-companies-2026-04-22.md`) was generated April 22, 2026. That is 52 days without a new research report. The Market Catalyst Agent has not produced a single deliverable since its first scan.
...
### 5. Latest Beta Is 2026.6.6-beta.2 (June 12)

The beta train has moved beyond 2026.6.5 to **2026.6.6-beta.2** (released June 12). Next expected stable is **2026.7.x in early July**. Do not chase the beta. Upgrade target remains 2026.6.5 stable for both instances.
...
# Cross-Customer Analysis — Fleet Scan 2026-06-13 (Archived)
...
Heather is supposed to manage Josh's email, calendar, and contacts. Without a connected Google account, she can't do any of it. Noah's instance has full Google Workspace access. Josh has zero. **[June 14 update: inbox-state.json confirms email/iMessage have been offline for 44–47 days, not 9.]**
...
Market Catalyst doesn't know who Noah is, their timezone (critical for market hours), risk tolerance, or trading focus. Josh's USER.md is detailed and useful. Noah's is an empty template. **[June 14 update: AE report confirmed 52 days stale as of June 13.]**
...
4. Reports output directory (one report, 52 days stale)
...
2. Model fallbacks (OpenRouter fallbacks provide resilience — **fix the gemini-2.5-flash one by June 17**)
...
5. **Not updated to 2026.6.5** — both missing Meeting Notes (2026.5.26), Parallel search, Anthropic recovery fixes
6. **Cron bug #11726** — both should use isolated sessions + direct Discord delivery (not sessionTarget: main)
...
*Next recommended scan: 2026-06-14 evening.*
